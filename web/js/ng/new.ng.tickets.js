...
MiscUtils = {
    ...
    adjustWeekDay: function(date, weekDay) {
        ...
        var miliss = date.getTime() + daysToAdd * 24 * 60* 60 * 1000;
        return new Date(miliss);
    }
};
...
(function() {
    ...
    SelectionBoard.prototype = {
        ...
        init : function() {
            ...
            var forthDateWidget = getDateField(this.$forthDatePicker, selectedForthDate, function(date) {
            ...
            var backDateWidget = getDateField(this.$backDatePicker, selectedBackDate, function(date) {
    ...
    TripsBoard.prototype = {
        ...
        hide: function() {
            if (this.$container.css('display') == 'none') return;

            this.$createTicketBtn.addClass('btn-hidden');
            this.$container.animate({
                height: "toggle"
            }, 300);
        },
...
//            });
        ...
        hide: function(callback) {
            var that = this;
            //hiding price block
            this.$ticketBoard.find('.ticket-price-sum').animate({
                opacity: 0
            }, 200, function() {
